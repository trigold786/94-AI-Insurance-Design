-- 002_seed_policies: seed data for policy-crawler MVP 5 cities
-- depends on: 001_init

BEGIN;

-- ======== Policy Sources ========
INSERT INTO policy_sources (source_id, source_name, source_url, source_level, weight, enabled)
VALUES
('SRC-SH-GOV', '上海人社局官网', 'https://rsj.sh.gov.cn', 'HIGH', 1.0, TRUE),
('SRC-BJ-GOV', '北京人社局官网', 'https://rsj.beijing.gov.cn', 'HIGH', 1.0, TRUE),
('SRC-SZ-GOV', '深圳人社局官网', 'https://hrss.sz.gov.cn', 'HIGH', 1.0, TRUE),
('SRC-GZ-GOV', '广州人社局官网', 'https://rsj.gz.gov.cn', 'HIGH', 1.0, TRUE),
('SRC-HZ-GOV', '杭州人社局官网', 'https://hrss.hangzhou.gov.cn', 'HIGH', 1.0, TRUE),
('SRC-NHSA', '国家医保局', 'https://www.nhsa.gov.cn', 'HIGH', 1.0, TRUE),
('SRC-MOHRSS', '人社部', 'https://www.mohrss.gov.cn', 'HIGH', 1.0, TRUE);

-- ======== 上海 (310000) - Policy Claims ========
INSERT INTO policy_claims (claim_id, policy_id, region_code, policy_type, target_group_tags, subsidy_calc_method, subsidy_amount_min, subsidy_amount_max, subsidy_duration, effective_date, expire_date, confidence_score, status)
VALUES
('CLM-SH-PEN-001', 'SH-2025-PENSION', '310000', 'pension', '{all,employed,flexible}',
 '基数*8%+基数*16%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
('CLM-SH-MED-001', 'SH-2025-MEDICAL', '310000', 'medical', '{all,employed,flexible}',
 '基数*2%+基数*9%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
('CLM-SH-UNE-001', 'SH-2025-UNEMPLOYMENT', '310000', 'unemployment', '{all,employed}',
 '基数*0.5%+基数*0.5%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-SH-INJ-001', 'SH-2025-INJURY', '310000', 'injury', '{all,employed}',
 '基数*0.5%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-SH-MAT-001', 'SH-2025-MATERNITY', '310000', 'maternity', '{all,employed,female}',
 '基数*1%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-SH-HOU-001', 'SH-2025-HOUSING', '310000', 'housing_fund', '{all,employed}',
 '基数*5%~7%+基数*5%~7%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-SH-SUB-001', 'SH-2025-FLEX-SUBSIDY', '310000', 'subsidy', '{flexible,4050}',
 '基数*50%', 7380, 12383, 36, '2025-01-01', '2025-12-31', 0.90, 'verified'),
('CLM-SH-SUB-002', 'SH-2025-TRAINING', '310000', 'training', '{flexible,unemployed}',
 '按课时补贴', 500, 3000, 12, '2025-01-01', '2025-12-31', 0.85, 'verified');
...
('CLM-BJ-MED-001', 'BJ-2025-MEDICAL', '110000', 'medical', '{all,employed,flexible}',
 '基数*2%+3+基数*9.8%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
...
('CLM-BJ-INJ-001', 'BJ-2025-INJURY', '110000', 'injury', '{all,employed}',
 '基数*0.4%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-BJ-MAT-001', 'BJ-2025-MATERNITY', '110000', 'maternity', '{all,employed,female}',
 '基数*0.8%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-BJ-HOU-001', 'BJ-2025-HOUSING', '110000', 'housing_fund', '{all,employed}',
 '基数*5%~12%+基数*5%~12%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-BJ-SUB-001', 'BJ-2025-FLEX-SUBSIDY', '110000', 'subsidy', '{flexible,4050}',
 '基数*50%', 9460, 15764, 36, '2025-01-01', '2025-12-31', 0.90, 'verified');
...
('CLM-SZ-MED-001', 'SZ-2025-MEDICAL', '440300', 'medical', '{all,employed,flexible}',
 '基数*2%+基数*6.2%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
('CLM-SZ-UNE-001', 'SZ-2025-UNEMPLOYMENT', '440300', 'unemployment', '{all,employed}',
 '基数*0.3%+基数*0.7%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-SZ-INJ-001', 'SZ-2025-INJURY', '440300', 'injury', '{all,employed}',
 '基数*0.14%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-SZ-MAT-001', 'SZ-2025-MATERNITY', '440300', 'maternity', '{all,employed,female}',
 '基数*0.45%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
...
('CLM-SZ-SUB-001', 'SZ-2025-FLEX-SUBSIDY', '440300', 'subsidy', '{flexible,4050}',
 '基数*50%', 6525, 14530, 36, '2025-01-01', '2025-12-31', 0.90, 'verified');
...
('CLM-GZ-MED-001', 'GZ-2025-MEDICAL', '440100', 'medical', '{all,employed,flexible}',
 '基数*2%+基数*6.85%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
('CLM-GZ-UNE-001', 'GZ-2025-UNEMPLOYMENT', '440100', 'unemployment', '{all,employed}',
 '基数*0.2%+基数*0.8%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-GZ-INJ-001', 'GZ-2025-INJURY', '440100', 'injury', '{all,employed}',
 '基数*0.16%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
('CLM-GZ-MAT-001', 'GZ-2025-MATERNITY', '440100', 'maternity', '{all,employed,female}',
 '基数*0.85%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.95, 'verified'),
...
('CLM-GZ-SUB-001', 'GZ-2025-FLEX-SUBSIDY', '440100', 'subsidy', '{flexible,4050}',
 '基数*50%', 8280, 13795, 36, '2025-01-01', '2025-12-31', 0.90, 'verified');

-- ======== 杭州 (330100) ========
INSERT INTO policy_claims (claim_id, policy_id, region_code, policy_type, target_group_tags, subsidy_calc_method, subsidy_amount_min, subsidy_amount_max, subsidy_duration, effective_date, expire_date, confidence_score, status)
VALUES
('CLM-HZ-PEN-001', 'HZ-2025-PENSION', '330100', 'pension', '{all,employed,flexible}',
 '基数*8%+基数*15%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
('CLM-HZ-MED-001', 'HZ-2025-MEDICAL', '330100', 'medical', '{all,employed,flexible}',
 '基数*2%+基数*9.5%', NULL, NULL, NULL, '2025-01-01', '2025-12-31', 0.98, 'verified'),
...
('CLM-HZ-SUB-001', 'HZ-2025-FLEX-SUBSIDY', '330100', 'subsidy', '{flexible,4050}',
 '基数*50%', 5850, 9625, 36, '2025-01-01', '2025-12-31', 0.90, 'verified');
