...
CREATE TABLE relevance_rules (
    ...
    category TEXT NOT NULL,           -- 险种/政策动词/金额时间/人群/政策文档/自定义
...
New "相关性规则" tab in admin dashboard:
...
API: ByteDance OpenSpeech (火山引擎语音技术)
...
├── admin/
│   ├── admin_page.go         # New "相关性规则" tab, ASR config section, test panel
